...
<body>
    ...
    <table class="table table-bordered mt-5">
        ...
        <?php
        $get_order_detils="Select * from `user_orders` where user_id=$user_id";
        $result_order=mysqli_query($con,$get_order_detils);
        $number=1;
